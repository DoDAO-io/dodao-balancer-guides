...
## veBAL
In April 2022, Balancer adopted the vote escrowed model (veModel). Under this model, users who lock their veBAL tokens for a longer period of time have more voting rights in the Protocol. Additionally, users who invest in the BAL/WETH 80/20 Pool are rewarded with BPT (Balancer Pool Token). veBAL lockers also receive 75% of protocol fees. In addition to 75% of protocol revenues, veBAL holders also get 10% of all BAL minted weekly.
